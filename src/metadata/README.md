 ...
 * [hmdm.yml](hmdm.yml)
     * Determines how your purl.obolibrary.org/obo/hmdm/ redirects will be handled
     ...
     * Paste in the contents of [hmdm.yml](hmdm.yml)
 ...
 * [hmdm.md](hmdm.md)
     ...
     * Paste in the contents of [hmdm.md](hmdm.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
